...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "Tempus — Ciclos Invisíveis das Gerações" },
      { property: "og:title", content: "Tempus — Ciclos Invisíveis das Gerações" },
      {
      ...
      { name: "twitter:title", content: "Tempus — Ciclos Invisíveis das Gerações" },
      {
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,600;0,700;1,400;1,600;1,700&family=Cinzel:wght@400;500;600&family=Lato:wght@300;400;700&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
